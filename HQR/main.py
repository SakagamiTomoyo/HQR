...
import torch
import qaidn_2.data_loader as data_loader
import qaidn_2.utils as utils
from qaidn_2.GQE_N import GQE
from qaidn_2.analysis.analysis import answer_cluster
from qaidn_2.IDN_GQE_21_N import IDN_GQE_21 as IDN_GQE
from qaidn_2.analysis.IDN_GQE_TSNE import IDN_GQE_TSNE
from qaidn_2.analysis.GQE_TSNE import GQE_TSNE
from qaidn_2.IDN_GQE_DistMult import IDN_GQE_DistMult
from qaidn_2.IDN_GQE_RotatE import IDN_GQE_RotatE
from qaidn_2.IDN_Q2B_24_N import IDN_Q2B_24 as IDN_Q2B
from qaidn_2.IDN_CQD_CO_24_N import IDN_CQD_CO_24 as IDN_CQD_CO
from qaidn_2.train_helper import train_ingredient, run_train
...
parser.add_argument('--tasks', type=str, default='1p.2p.3p.2i.3i.ip.pi.2u.up',
                    help="tasks' types")
parser.add_argument("--data_dir", type=str, default="../Fb15k-237-q2b/",
                    help="location of data")
parser.add_argument("--log_dir", type=str, default="./log/",
                    help="location of logging file")
parser.add_argument("--model_dir", type=str, default="./model/gqe_237_",
...
parser.add_argument("--model", type=str, default="idn-gqe-tsne")
parser.add_argument("--KGReasoning_setting", type=bool, default=True)
