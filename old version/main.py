...
from IDN_CQD import IDN_CQD_CO_24 as IDN_CQD_CO
...
parser.add_argument("--data_dir", type=str, default="./NELL-q2b/",
                    help="location of data")
parser.add_argument("--log_dir", type=str, default="./log/",
                    help="location of logging file")
parser.add_argument("--model_dir", type=str, default="./model/idncqd_500bs_nell_10_",
...
parser.add_argument("--model", type=str, default="idn-cqd-co")
...
parser.add_argument("--max_iter", type=int, default=0,
                    help="max epoch")
parser.add_argument("--pre_sample", type=bool, default=False,
...
# train_queries = {}
# train_queries[('e', ('r',))] = set()
# train_queries[('e', ('r',))].add((1104, (17, )))
...
if args.opt == "sgd":
    ...
    # if args.model == 'idn-gqe-distmult' or args.model == 'idn-gqe-complex':
    #     param_gqe = []
    #     param_mlp = []
    #
    #     for param in optimizer.param_groups[0]['params']:
    #         if param is model.entity_embedding or \
    #                 param is model.relation_embedding or \
    #                 param is model.center_net.layer1.weight or \
    #                 param is model.center_net.layer2.weight or \
    #                 param is model.center_net.layer1.bias or \
    #                 param is model.center_net.layer2.bias:
    #             param_gqe.append(param)
    #         else:
    #             param_mlp.append(param)
    #
    #     optimizer = optim.Adam([{'params': param_gqe}, {'params': param_mlp, 'lr': 1e-5}],
    #                            lr=args.lr, weight_decay=args.weight_decay)
